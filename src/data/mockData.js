export const skills = [
  ...
  { name: "C++", category: "SDE", experience: "3 years", level: "Advanced", projects: ["Algorithm Visualizer", "Data Structures Library"], x: -4.5, y: 1.5, z: 0 },
  { name: "React", category: "SDE", experience: "2 years", level: "Advanced", projects: ["Portfolio", "E-commerce Dashboard"], x: -4, y: 0, z: 0.8 },
  { name: "Node.js", category: "SDE", experience: "2 years", level: "Intermediate", projects: ["REST API Server", "Microservices"], x: -5, y: -0.8, z: -0.5 },
  { name: "JavaScript", category: "SDE", experience: "3 years", level: "Expert", projects: ["Multiple Web Apps"], x: -3.5, y: 2.5, z: -0.8 },
  { name: "Java", category: "SDE", experience: "2 years", level: "Advanced", projects: ["Enterprise Applications"], x: -3.8, y: -1.5, z: 0.7 },
  { name: "SQL", category: "SDE", experience: "3 years", level: "Advanced", projects: ["Database Design", "Query Optimization"], x: -5.3, y: 2, z: -0.9 },
  { name: "Express.js", category: "SDE", experience: "2 years", level: "Intermediate", projects: ["REST APIs", "Backend Services"], x: -4.8, y: -2, z: 0.5 },
  { name: "Git", category: "SDE", experience: "3 years", level: "Advanced", projects: ["All Projects"], x: -5.5, y: 0.5, z: 0 },
  { name: "VS Code", category: "SDE", experience: "3 years", level: "Expert", projects: ["Development Environment"], x: -3.2, y: 0.8, z: -1 },
  { name: "MongoDB", category: "SDE", experience: "2 years", level: "Intermediate", projects: ["NoSQL Databases"], x: -4.2, y: -0.5, z: -1.2 },
  { name: "MySQL", category: "SDE", experience: "2 years", level: "Advanced", projects: ["Relational Databases"], x: -5.8, y: -1.2, z: -0.3 },
  
  // AI/ML Skills - Green cluster (center) - Better spacing
  { name: "Python", category: "AI/ML", experience: "4 years", level: "Expert", projects: ["ML Pipeline", "Data Analysis"], x: 0, y: 1.8, z: 0 },
  { name: "PyTorch", category: "AI/ML", experience: "2 years", level: "Advanced", projects: ["Neural Network Models", "Image Classification"], x: 1, y: 0.5, z: 0.9 },
  { name: "TensorFlow", category: "AI/ML", experience: "2 years", level: "Advanced", projects: ["Deep Learning Projects"], x: -1, y: 0, z: -0.9 },
  { name: "Scikit-learn", category: "AI/ML", experience: "3 years", level: "Advanced", projects: ["ML Algorithms", "Feature Engineering"], x: 0.5, y: 2.8, z: -0.6 },
  { name: "Machine Learning", category: "AI/ML", experience: "3 years", level: "Advanced", projects: ["Predictive Models", "Classification"], x: 1.5, y: 1.8, z: -0.7 },
  { name: "NLP", category: "AI/ML", experience: "2 years", level: "Advanced", projects: ["Text Analysis", "Sentiment Analysis"], x: -1.3, y: 1.5, z: 0.8 },
  { name: "Deep Learning", category: "AI/ML", experience: "2 years", level: "Advanced", projects: ["Neural Networks", "CNN"], x: 1.2, y: -1.8, z: 0.6 },
  { name: "Pandas", category: "AI/ML", experience: "3 years", level: "Expert", projects: ["Data Processing"], x: -0.8, y: -1.2, z: 0.8 },
  { name: "NumPy", category: "AI/ML", experience: "3 years", level: "Advanced", projects: ["Scientific Computing"], x: 1, y: -1, z: -0.5 },
  { name: "FAISS", category: "AI/ML", experience: "1 year", level: "Intermediate", projects: ["Vector Search", "Similarity Search"], x: -1.5, y: -2, z: -0.4 },
  { name: "Azure ML", category: "AI/ML", experience: "1 year", level: "Intermediate", projects: ["Cloud ML Services"], x: 0.8, y: 2.2, z: 0.9 },
  
  // GenAI Skills - Pink cluster (right side) - Better spacing
  { name: "Transformers", category: "GenAI", experience: "1.5 years", level: "Advanced", projects: ["LLM Fine-tuning", "RAG System"], x: 4.2, y: 1.5, z: 0 },
  { name: "LangChain", category: "GenAI", experience: "1 year", level: "Intermediate", projects: ["RAG Applications", "Agent Systems"], x: 3.8, y: 0, z: 0.9 },
  { name: "OpenAI API", category: "GenAI", experience: "1 year", level: "Advanced", projects: ["ChatBot", "AI Assistant"], x: 5, y: -0.8, z: -0.6 },
  { name: "RAG Systems", category: "GenAI", experience: "1 year", level: "Advanced", projects: ["Document Q&A", "Knowledge Base"], x: 4.5, y: 2.5, z: 0.7 },
  { name: "GenAI", category: "GenAI", experience: "1.5 years", level: "Advanced", projects: ["Generative Models", "Content Generation"], x: 5.5, y: 1.2, z: 0.8 },
  { name: "Multimodal AI", category: "GenAI", experience: "1 year", level: "Intermediate", projects: ["Vision-Language Models"], x: 3.5, y: 2.2, z: -0.8 },
  { name: "Vector DBs", category: "GenAI", experience: "1 year", level: "Intermediate", projects: ["Embeddings Store", "Similarity Search"], x: 3.2, y: -1.5, z: 0 },
  { name: "Pinecone", category: "GenAI", experience: "1 year", level: "Intermediate", projects: ["Vector Storage"], x: 4.8, y: -1.8, z: 0.9 },
  { name: "Qdrant", category: "GenAI", experience: "1 year", level: "Intermediate", projects: ["Vector Database"], x: 3, y: -2.2, z: -0.7 },
  { name: "FastAPI", category: "GenAI", experience: "1.5 years", level: "Advanced", projects: ["API Development", "ML Serving"], x: 5.2, y: 0.5, z: -0.9 },
  { name: "Prompt Eng", category: "GenAI", experience: "1.5 years", level: "Advanced", projects: ["LLM Optimization"], x: 4, y: -2, z: -0.8 },
];
